class RatingItem: NamedHotelDetailsItem {
    ...
    override func cellHeight(tableWidth: CGFloat) -> CGFloat {
        ...
        if let description = trustYou.summaryDescription {
            ...
            let descriptionHeight = description.hl_height(attributes: [NSAttributedString.Key.font: HLHotelDetailsRatingSummaryCell.descriptionLabelFont], width: descriptionWidth)
